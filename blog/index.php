  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        ...
        <p class="lead blog-description">Contoh Blog.</p>
      </div>
        ...
        <div class="col-sm-8 blog-main">
          ...
          <?php
                  ...
                  while ($r=mysqli_fetch_array($kategori)) {
                    ...
                    echo "<h2 class='blog-post-title'> $r[judul_berita] </h2>";
                    echo "<p class='blog-post-meta'> $r[tanggal] <a href='#'> $r[penulis]</a></p>";
                    echo "<p> $r[isi_berita] </p> </div>";
                 }
          ?>
