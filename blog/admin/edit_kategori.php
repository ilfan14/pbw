...
<html lang="en">
  <head>
    ...
    <title>Ndes' MOVIE - Edit Ketegori</title>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="update.php?jenis=kategori" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                          ...
                          <div class="" style="float:left;">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" value=<?php echo $data['kategori']; ?> placeholder="Nama kategori">
                              </div>
                          </div>
